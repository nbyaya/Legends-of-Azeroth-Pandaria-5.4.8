...
enum Adds
{
    ...
    NPC_LORD_VICTOR_NEFARIUS_A          = 43396, // 礤 筲屦屙
...
Unit* atramedesTarget; // 鲥朦 塍鬣 囹疣戾溧
Creature* atramedesShield; // 镱耠邃龛?桉镱朦珙忄眄 ?
...
// 羿玎 80皴? 珥圜栩 镳桁屦眍 赅驿 13 皴牦礓 黩?蝾 漕腈眍 赅耱钼囹, 镱珂?磬耱痤?蜞殪屦?蝾黜邋
//
