...
// 疣珙狃囹 ?耧咫豚扈 electric instability, lava seed, liquid ice
// 磬轵?忮蹊觌桎 潆 avity crash
...
enum Events
{
    ...
    EVENT_PHASE_3_1                     = 20, // 滂嚯钽?
    EVENT_PHASE_3_2                     = 21, // 滂嚯钽?
    EVENT_PHASE_3_3                     = 22, // 滂嚯钽?
    EVENT_PHASE_3_4                     = 23, // 滂嚯钽?
...
enum Adds
{
    ...
    NPC_ASCENDANT_COUNCIL_TARGET_STALKER    = 44553,    //礤镱?蝽? 铗牦溧 ?
...
{
    { -1053.54f, -564.38f, 835.02f, 5.81f }, // 嚓忄痂铐
    { -1054.04f, -600.60f, 835.03f, 0.42f }, // 钽龛?
    { -1057.89f, -653.51f, 877.70f, 0.79f }, // 囵桀?
    { -1057.93f, -533.38f, 877.68f, 5.47f }, // 蝈痧囫蝠?
};

const Position groundPos[7] = 
{
    { -1038.45f, -590.60f, 831.98f, 6.04f }, // 磬 2?羿珏 颃溧 镳噱?囵桀?
    { -1034.61f, -571.70f, 831.90f, 6.04f }, // 磬 2?羿珏 颃溧 镳噱?蝈痧囫蝠?
    { -1008.42f, -571.32f, 831.90f, 4.71f }, // 磬 3?羿珏 桉躅漤? 蝾麝?嚓忄痂铐?
    { -995.92f, -582.68f, 831.90f, 3.18f  }, // 磬 3?羿珏 桉躅漤? 蝾麝?钽龛襦
    { -1008.75f, -594.82f, 831.90f, 1.52f }, // 磬 3?羿珏 桉躅漤? 蝾麝?囵桀磬
    { -1020.88f, -582.67f, 831.90f, 0.0f  }, // 磬 3?羿珏 桉躅漤? 蝾麝?蝈痧囫蝠?
    { -1008.58f, -582.97f, 831.90f, 6.23f }, // 磬 3?羿珏 蝾麝?耧噔磬 祛眈蝠铖栩?
};
